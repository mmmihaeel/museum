...
import $, { extend, inArray, Event, fn, isTouch as _isTouch } from 'jquery';
...
var has3d,
	...
	turnMethods = {
		...
		init: function (opts) {
			...
			let i, data = this.data(), ch = this.children();
		...
		size: function (width, height) {
			...
			if (width && height) {
				...
				let data = this.data(), pageWidth = (data.display == 'double') ? width / 2 : width, page;
		...
		stop: function (ok) {
			...
			let i, opts, data = this.data(), pages = data.pageMv;
		...
		_showFoldedPage: function (c, animate) {
			...
			if (folding) {
				...
				if (animate) {
					...
					const that = this, point = (data.point && data.point.corner == c.corner) ? data.point : flipMethods._c.call(this, c.corner, 1);
